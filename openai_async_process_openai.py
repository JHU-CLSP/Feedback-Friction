...
math_datalist = None
iterations = 10
client = OpenAI(api_key="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")
    ...
    if len(normalized_prediction_list) != 0 and normalized_prediction_list[0] != get_normalized_answer(dataset, data):
        ...
        completion = client.chat.completions.create(
            ...
            messages=[
                ...
                {
                    "role": "user",
                    "content": "There is a previous mistake on answering this question. Question: " + data[get_dataset_key(dataset)] + "\nAnswer: " + response_list[0] + "\nThe correct final answer should be: " + get_normalized_answer(dataset, data) + "\nPlease give me feedback on which step is wrong or how to get to the correct answer without giving up the correct answer: "
                }
            ]
        )
...
if __name__ == '__main__':
    ...
    parser.add_argument("--base_url", type=str, default="http://c002", help="Base URL to use for the agent server")
